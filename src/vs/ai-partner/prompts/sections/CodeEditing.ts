...
function getCorePrinciples(): string {
    return `<!-- CORE PRINCIPLES (Agent Specific) -->
**CORE PRINCIPLES:**
...
function getCriticalRules(thinkingLang: string, userLanguage: string): string {
    return `<!-- CRITICAL RULES (Agent Specific) -->
**CRITICAL RULES:**
1. **Tool Usage**:
...
function getUserPreferences(userPrefs: { language: string; codingStyle: string; preferredFrameworks: string[] }): string {
    return `<!-- USER PREFERENCES (Fixed by Orchestrator) -->
**USER PREFERENCES:**
...
function getUserCustomRules(): string {
    return `<!-- USER CUSTOM RULES (Fixed by Orchestrator) -->
...
function getComplexityControl(complexity: number): string {
    return `<!-- COMPLEXITY CONTROL (Agent Specific) -->
## COMPLEXITY CONTROL
...
function getToolUsage(): string {
    return `<!-- TOOL & ACTION GUIDELINES (Agent Specific) -->
<tool_usage>
## PRIMARY TOOLS
...
function getChatHistory(): string {
    return `<!-- CHAT HISTORY (Fixed by Orchestrator) -->
## CHAT HISTORY
...
function getProjectContext(): string {
    return `<!-- PROJECT CONTEXT (Fixed by Orchestrator) -->
**PROJECT CONTEXT:**
