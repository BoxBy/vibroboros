...
export declare class OrchestratorAgent {
    ...
    private currentPlan;
    private planKind;
    private hasExecutedCoreFollowups;
    private lastPlanSummary;
    private _specialistAgentDescriptions;
    private isAwaitingPlanConfirmation;
    private autonomousMode;
    private activeSessionId;
    private totalUsedTokens;
    private lastAttachmentFilePaths;
    private lastUserInputAt;
    private lastDispatchedStep;
    private lastDispatchedAt;
    private lastAppliedFilePath;
    private recentlyAppliedFiles;
    private planId;
    private currentStepIndex;
    private currentExecutionId;
    private handledExecutions;
    private producedArtifacts;
    private deferredPostActions;
    private isAwaitingPostActionsConfirmation;
    private pendingPostActions;
    private suppressPostActionsSuggestions;
    private stickyAgentName;
    private stickyExpiresAt;
    private brainstormContextId;
    ...
    initialize(registeredAgentConfigs: {
        name: string;
        description: string;
    }[]): Promise<void>;
    ...
    private handlePostActionsConfirmation;
    private interpretPostActionsSelection;
    ...
    private updateSessionTitleSummary;
    private executePlan;
     ...
     */
    private pruneLlmHistoryIfNeeded;
    ...
    private sendPlanCompletionSummary;
    private recordArtifact;
    private buildDynamicPostActionsFromArtifacts;
    private handleError;
    private updateDiagnostics;
    private extractPlanArray;
}
